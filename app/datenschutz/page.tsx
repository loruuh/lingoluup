...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung - HablaPalabra',
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-4">
            ...
            <Section id="ueberblick" badge="§1" title="Datenschutz auf einen Blick">
              <div className="space-y-3 text-gray-300 text-sm leading-relaxed">
                <p>
                  ...
                  personenbezogenen Daten passiert, wenn Sie HablaPalabra nutzen.
                </p>
                <p>
            ...
            <Section id="hosting" badge="§3" title="Hosting & Datenspeicherung">
              ...
              <ProviderCard
                name="Vercel (Hosting)"
                address="Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA. Vercel hostet die HablaPalabra-Webanwendung. Datenverarbeitung auf Servern in den USA; Vercel ist unter dem EU-US Data Privacy Framework zertifiziert."
